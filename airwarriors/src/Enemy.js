var Enemy = cc.Sprite.extend({
    ...
    shoot: function () {
        var p = this.getPosition();
        if (this.enemyType >= 3) {
            var b1 = Bullet.getOrCreateBullet(this.bulletSpeed, "Bullet02.png", this.attackMode, 3000, MW.UNIT_TAG.ENMEY_BULLET);
            var b2 = Bullet.getOrCreateBullet(this.bulletSpeed, "Bullet02.png", this.attackMode, 3000, MW.UNIT_TAG.ENMEY_BULLET);

            b1.setPosition(p.x - 10, p.y - this.getContentSize().height * 0.2);
            b2.setPosition(p.x + 10, p.y - this.getContentSize().height * 0.2);
        }
        else {
            var b = Bullet.getOrCreateBullet(this.bulletSpeed, "Bullet02.png", this.attackMode, 3000, MW.UNIT_TAG.ENMEY_BULLET);
