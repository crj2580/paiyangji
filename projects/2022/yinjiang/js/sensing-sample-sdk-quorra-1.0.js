var SensingDevice = /** @class */ (function () {
  ...
  SensingDevice.prototype.addBehaviorRecord = function (
    thingId,
    thingName,
    thingCategory,
    action,
    ...
    if (window.android != null && typeof window.android != "undefined") {
      var success = window.android.addBehaviorRecord(
        thingId,
        thingName,
        thingCategory,
        action,
  ...
  SensingDevice.prototype.addBehaviorRecordObject = function (record) {
    if (window.android != null && typeof window.android != "undefined") {
      var success = window.android.addBehaviorRecord(
        record.thingId,
        record.thingName,
        record.thingCategory,
        record.action,
        record.increment,
        record.collectionTime,
        record.collectEndTime,
        record.softwareName,
        record.pageName,
        record.pageArea,
        record.previousPageName,
        record.previousPageArea,
        record.position,
        record.pSource,
        record.comments
      );
  ...
  SensingDevice.prototype.log = function (content) {
    if (window.android != null && typeof window.android != "undefined") {
      return window.android.log(content);
    } else {
      // alert(typeof window.android);
    }
  };
