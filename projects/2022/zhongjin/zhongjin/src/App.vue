...
securityKey.value = mSensingDevice.getSecurityKey() || "a69b17366efc4f8bb455ec4b059208d4"; //troncellshow
subKey.value = mSensingDevice.getSubKey() || "7ddd9972b8714dc2aa5539b79c03aea2";
...
const selectAnswer = (answer) => {
  ...
  // console.log(answer);
  if (answer.isAnswer) {
    if (realQuestionIndex.value < questionNeedLength.value) {
      clearInterval(timer.value);
      setTimeout(() => {
        continuer();
      }, 1000);
