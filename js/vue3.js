var Vue = (function (exports) {
  ...
  */
  ...
  class VueElement extends BaseClass {
      constructor(_def, _props = {}, _attrKeys, _propKeys, hydrate) {
          super();
          this._def = _def;
          this._props = _props;
          this._attrKeys = _attrKeys;
          this._propKeys = _propKeys;
          /**
           * @internal
           */
          this._instance = null;
              ...
              if (memo) {
                  ...
                  loop.body = createBlockStatement([
                      ...
                      createCompoundExpression([
                          ...
                          ` && ${context.helperString(IS_MEMO_SAME)}(_cached.memo, _memo)) return _cached`
                      ]),
