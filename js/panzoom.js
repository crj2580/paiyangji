...
function createPanZoom(domElement, options) {
  ...
  function startTouchListenerIfNeeded() {
    console.log("startTouchListenerIfNeeded")//troncell
    if (touchInProgress) {
  ...
  //     document.removeEventListener('touchend', releaseFn);
  //     document.removeEventListener('touchcancel', releaseFn);
  //   };
  // document.addEventListener('touchstart', function () {
  //   document.addEventListener('touchmove', moveFn);
  //   document.addEventListener('touchend', releaseFn);
  //   document.addEventListener('touchcancel', releaseFn);
  // });
  //owner touchstart 判断touchInProgress 为false则添加move/end事件 当end时解绑所有事件
  //kewosi下不做解绑 此外如果touchInProgress为true时屏幕内其他元素也会无法move事件
